...
- `app/(app)/samples/page.tsx` — toast.info pra reconciliação otimista (~linha 1098), toast.error pra falha de listSamples pra liga (~linha 1120), toast.info pra `showIneligibleReason` (~linha 1382). Pattern title + description curto.
