...
- A pagina **"Relatorios"** e a rota **`/relatorios`** (`app/relatorios/page.tsx`); `/informe` e `/resumo` redirecionam pra ela (server-side). **ACESSO UNIFICADO (2026-07-15):** guard `INFORME_ROLES` = `NON_PROSPECTOR_ROLES` — **todo papel nao-PROSPECTOR** (ADMIN, CLASSIFIER, REGISTRATION, COMMERCIAL, CADASTRO) entra como VIEWER unico; o antigo ramo "meus" do COMMERCIAL foi aposentado.
