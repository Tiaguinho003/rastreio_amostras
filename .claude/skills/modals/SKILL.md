...
| /samples lista          | Envio: chooser de metodo (picker) central; laudo e envio fisico viraram paineis                                         | central + painel lateral             | ✅ F3 `f2815de`        |
...
| /samples ?lote=         | Imprimir etiqueta = painel; **editar envio E data = dropdown INLINE** abaixo do card da timeline                        | painel / inline                      | ✅ `53933c8`+`6e138a4` |
