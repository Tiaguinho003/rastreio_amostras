...
```tsx
<section className="app-modal is-themed samples-filter-modal">
```

E definir overrides no CSS pelo seletor combinado:

```css
.samples-filter-modal .app-modal-header {
  /* override pontual */
}
```
