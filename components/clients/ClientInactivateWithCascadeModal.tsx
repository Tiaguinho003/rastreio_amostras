    ...
    <div className="app-modal-backdrop">
      ...
      >
        <div className="cdm-header">
          <h3 id="client-cascade-modal-title" className="cdm-header-name">
        ...
        <div className="sdv-cascade-warn">
          ...
          {hasMovements ? (
            <p className="sdv-cascade-warn-movements">
              ⚠ Algumas amostras possuem movimentações comerciais ativas (vendas/perdas). Cancele as
              movimentações antes — ou a operação será rejeitada.
            </p>
          ) : null}
        </div>
