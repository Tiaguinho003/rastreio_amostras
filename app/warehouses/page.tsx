              ...
              <>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', marginTop: '0.8rem' }}>
                  ...
                  {state.detail.status === 'ACTIVE' ? (
                    ...
                    <button type="button" className="cdm-manage-link" style={{ flex: 1, background: 'linear-gradient(135deg, #1B5E20, #2E7D32)' }} onClick={() => { setStatusAction('reactivate'); setStatusReason(''); setStatusError(null); }}>
                      Reativar
                    </button>
                  )}
                </div>
