...
// Evento do dashboard → `/contratos?tab=X&highlight=<contractId>`: quando o contrato
// tocado está na página JÁ carregada da worklist (Financeiro / Embarque), rola até ele
// e o "pisca" por ~2s. Uma vez por id (não re-dispara em refetch/scroll). Best-effort:
// se o contrato não está na página (paginação keyset), não faz nada — o dot leva à aba
