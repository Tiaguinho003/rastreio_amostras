...
- [ ] **Etapa 4** — Execução
  ...
  - [ ] Fase Q (em andamento)
    ...
    - [ ] Q.cls.2 ficha unificada (parcial — ficha física `a79626e`, CTA "Classificar" `f505926`, tela da câmera `e37deaa`, IA `864f619`; restam modais de revisão/tipo/classificadores, payload do completeClassification, cleanup do `TYPE_CONFIGS`, migration)
...
- [x] Modal de revisão dos dados extraídos (Q.cls.2.3) — decidido, **não implementado**
...
- [ ] **Modal de revisão** (Q.cls.2.3): implementar UI conforme decidido — layout espelha ficha, edição inline, foto em cima com zoom em overlay, validação "pelo menos 1 campo além do lote", botões Cancelar + Avançar.
