...
- [ ] **Etapa 4** — Execução
  ...
  - [ ] Fase Q (em andamento)
    ...
    - [ ] Q.cls.2 ficha unificada (parcial — ficha física `a79626e`, CTA "Classificar" `f505926`, tela da câmera `e37deaa`, IA `864f619`, modal de revisão `a39e305`, modal de tipo `8dbe36f`, avisos 3a/3b + modo manual `983ccc3`, modais de cross-validation/reclassify/classifier `9411ffe`, payload ficha unificada + reason persistido + sub-caminho 5 Flow B `aa7c591`+`1aa4845`+`a2c7594`+`40d91e4`+`2bc3a36`, frontend cleanup TYPE_CONFIGS `c18e435`+`6659bd6`; resta tipo selecionado depois → `CLASSIFICATION_UPDATED` audit + migration final)
