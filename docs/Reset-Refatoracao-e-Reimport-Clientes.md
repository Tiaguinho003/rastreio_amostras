...
| 12  | **Cadastro manual dos PFs + fazendas**                                       | em andamento — usuario optou por cadastrar manualmente PFs + fazendas direto pela UI (sem planilha/wizard L4). Antonio Jacinto + 4 fazendas ja em prod; restantes via fluxo manual |
| 13  | ~~Conferencia banco × planilha pos-cadastros manuais~~                       | **N/A** — sem planilha pra cruzar; cadastros manuais via UI nao precisam reconciliar com fonte externa                                                                             |
| 14  | **Melhorias UX detectadas durante cadastro manual**                          | 14.1+14.2+14.3 ✅ deployado; 14.4.A-D + 14.5.A ✅; 14.6.A-D ✅; 14.7.A-N + 14.7.N.1+N.2+N.3 ✅ todos em prod (revisao completa pagina detalhe + padronizacao visual)               |
| 15  | L3.5 — apagar 44 fotos orfas no GCS                                          | aguarda confirmacao usuario do download local                                                                                                                                      |
| 16  | M2 — desativar modo manutencao                                               | apos #12 terminar (usuario sinaliza quando os PFs+fazendas restantes estiverem cadastrados)                                                                                        |
