...
6. `docs/refactor-amostra-modal.md`
   Uso: plano ativo da refatoracao de Nova Amostra (pagina -> modal acionado por FAB) + reorganizacao da tabbar mobile com Perfil. Status: Em planejamento.
