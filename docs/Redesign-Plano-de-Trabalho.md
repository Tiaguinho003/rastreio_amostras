...
| **FV** | Frente visual **redefinida (RD11, §2.5)**: ciclo **página-a-página** — contêiner dos modais + design/layout juntos, a partir da referência aprovada (RD12–RD14); piloto `/cadastros`                                                                       | 🚧 E1 conferida ✔ + rodada de ajustes 1 (§2.6) — mais rodadas → plan mode E2                 |
