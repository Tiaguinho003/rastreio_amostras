...
> **Status**: F1 e F3 **✅ validadas** (2026-07-20, Flavio no dev local); **F2 (lote) implementada 2026-07-20** — aguarda validação 🖥️📱 (junto com os gates RD10 pendentes dela). **FV piloto `/cadastros`: E1 conferida ✔ + rodadas de ajuste 1–3 aplicadas (§2.6)** — rodada 2 unificou o detalhe (edição interna, documentos/contas inline); **rodada 3 (2026-07-21) o transformou em DRAWER DE PERFIL** (620px, hero com avatar/chips/ações redondas, 3 abas Visão geral·Documentos·Filiais, gráfico de linhas 6 meses no lugar do donut); /cadastros = EXEMPLO das outras páginas; mais rodadas possíveis antes do plan mode da E2 restante (peek swap, modais restantes, mobile — mobile entra na E2 de cada página)
...
| **FV** | Frente visual **redefinida (RD11, §2.5)**: ciclo **página-a-página** — contêiner dos modais + design/layout juntos, a partir da referência aprovada (RD12–RD14); piloto `/cadastros`                                                                       | 🚧 E1 conferida ✔ + rodadas 1–3 (§2.6; detalhe = drawer de perfil) — mais rodadas → plan mode E2 |
