...
| **FV** | Frente visual **redefinida (RD11, §2.5)**: ciclo **página-a-página** — contêiner dos modais + design/layout juntos, a partir da referência aprovada (RD12–RD14); piloto `/cadastros`                                                                       | 🚧 E1 conferida ✔ + rodadas 1–5 (§2.6; detalhe = drawer de perfil; modais internos = painéis laterais) — mais rodadas → plan mode E2 |
