...
### Câmera / Scanner (CAM) — ✅ validada no device (S12+S13+S14, 2026-07-20)
...
> confirmar) conferidos e funcionando. A seção CAM está CONCLUÍDA.
