...
| 9   | CTR    | Contratos          | `/contratos`                                                                  | ⬜     | —        | Reorganizada ANTES da revisão pelo ledger **RC** (`Contratos-Plano-de-Trabalho.md` §5, 2026-07-27): vira página única, absorve Embarque e Aprovações como **fases dentro do contrato** e a lista ganha filtro por fase. A revisão CTR só faz sentido sobre a página reorganizada — ver §RC abaixo                                                                                                                                                                                                                                                                             |
...
> depois desta tabela, e **vai ser extinta** pela **RC-D2** — redirect para `/contratos`.
> Criar uma linha para revisar uma página que some seria trabalho jogado fora; o que ela
> fazia (worklists de Embarque e Aprovações) é revisado dentro da linha **CTR**, para onde
> as duas capacidades migram.
