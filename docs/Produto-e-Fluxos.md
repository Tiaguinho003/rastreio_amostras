...
2. Dashboard dedicado: cards "Visitas hoje" e "Clientes novos hoje" (janela do dia no fuso de Brasilia; **excluem canceladas**), lista das PROPRIAS visitas (cards expansiveis compartilhados com o viewer Relatorios) e botao central "+" que abre o formulario de VISITA num bottom sheet. **Online-only** desde a UNIFICACAO (2026-07-15) — a fila offline e o contador de pendentes foram removidos.
...
7. O FAB da pagina Relatorios cria **tres** coisas, e a terceira nao e um registro: alem da Visita e do Semanal, a opcao **"Informativo"** (todo nao-PROSPECTOR, 2026-07-16) abre um fluxo de 3 fases — **Mercado** -> **Meteorologico** (pulavel) -> revisao — que gera **imagens 1080x1920 para o story do Instagram** e as entrega para download. **Nada e salvo**: sem banco, sem storage, sem historico, e a peca nao aparece no feed. Os valores sao **digitados por quem publica** (o app nao busca cotacao nem previsao) e a previsao do tempo entra como **print colado**. Doc: `docs/Informativos-Plano-de-Trabalho.md`.
