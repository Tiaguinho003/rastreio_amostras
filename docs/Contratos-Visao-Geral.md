...
- **A etiqueta EDITA de volta — dois campos, com cascata (RC-D96..D101, 2026-07-29):** ela deixou de ser write-only. Dos seis campos, só **"Nº compra"** e **"Lotes de origem"** são editáveis; os outros quatro (fechamento, produtor, armazém, sacas) exibem **valor**, não input, com uma nota dizendo que vêm do contrato. Os dois editáveis **gravam antes de imprimir**:
