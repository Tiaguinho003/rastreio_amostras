...
> **Desenho da Sessão 62 + refino concreto da Sessão 63 (2026-06-29).** Implementação = **Fase F** (a
> fazer). Decisões **D77–D86**. **Relatório derivado, sem schema novo.**
...
- **Fase F — Página Financeiro (a implementar).** Relatório **derivado, sem migration** (D77–D86). Desenho
