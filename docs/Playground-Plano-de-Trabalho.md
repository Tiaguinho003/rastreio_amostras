...
> **Status**: ESPECIFICADO — decisões PG1–PG36 fechadas (funcional + layout/UX) e fases congeladas em 2026-07-13 (nenhuma linha de código escrita; pendentes deliberados: Q-F11, Q-T2/desenho do algoritmo, DEP-1)
