...
> **Status**: ESPECIFICADO — decisões PG1–PG24 fechadas e fases congeladas em 2026-07-13 (nenhuma linha de código escrita; pendentes deliberados: Q-F11, Q-T2/desenho do algoritmo, DEP-1)
...
| ---------------------- | ------------------------------------------------------------ | -------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Lote**               | Fonte: um lote real                                          | —        | 1      | Picker de lote real (busca por número/dono/safra; **só lotes classificados**, PG9); quantidade de sacas a contribuir (máximo = `availableSacks` físico, PG8+PG10) |
| **Mistura**            | Combina 2+ entradas                                          | N        | 1      | — (a proporção vem das sacas configuradas nos nodes de entrada)                                                                                                   |
| **Resultado**          | Exibe características estimadas da liga simulada             | 1        | —      | Resumo no node + painel lateral com a ficha estimada completa (PG18)                                                                                              |
