...
| **Aprovações** | **Modal** `ApprovalLabelModal` por 2 portas: leque "+" de `/samples` + atalho no card de Eventos do dashboard. Sinal/lembrete no modal de emissão. **Sem página** | `components/ApprovalLabelModal.tsx` (508 L) | ✅ reforma AP1–AP16 (2026-07-09); parte não commitada; não pushado |
